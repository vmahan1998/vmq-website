...
<div class="hero-container">
  ...
  <!-- Logo -->
  <div class="hero-logo">
    <img src="images/vmq.png" class="hero-logo-img">
  </div>

  <!-- Title -->
  <h1 class="hero-title">Ecological Modeling for Dynamic Estuary Systems</h1>

  <!-- Subtitle -->
  <p class="hero-subtitle">
    Hydrodynamics • Agent-Based Models • Mercury Exposure • Habitat Modeling • Co-Production
  </p>

  <!-- CTA Button -->
  <a href="models/abm/index.qmd" class="hero-button">Explore My Models</a>
...
<div class="wrap">
  ...
  <div class="tile">
    ...
    <a href="models/abm/index.qmd">
      <div class="text">
        ...
        <p class="animate-text">Behavioral ecology, schooling, environmental cues, exposure pathways.</p>
  ...
  <!-- TILE 2 -->
  <div class="tile">
    <img src="images/home_sections/hsi.jpg" />
    <a href="models/habitat/index.qmd">
      <div class="text">
        <h1>Habitat & HSI Models</h1>
        <p class="animate-text">Life-stage HSI, integrated fitness, Penobscot mapping.</p>
        <div class="dots"><span></span><span></span><span></span></div>
      </div>
    </a>
  </div>
  ...
  <!-- TILE 3 -->
  <div class="tile">
    <img src="images/home_sections/contaminants.jpg" />
    <a href="models/contaminants/index.qmd">
      <div class="text">
        <h1>Contaminant Exposure</h1>
        <p class="animate-text">SPM transport × hydrodynamics × MeHg bioaccumulation.</p>
        <div class="dots"><span></span><span></span><span></span></div>
      </div>
    </a>
  </div>
  ...
  <!-- TILE 4 -->
  <div class="tile">
    <img src="images/home_sections/outreach.jpg" />
    <a href="events/outreach/index.qmd">
      <div class="text">
        <h1>Co-Development & Outreach</h1>
        <p class="animate-text">Workshops, Tribal partnerships, science communication.</p>
        <div class="dots"><span></span><span></span><span></span></div>
      </div>
    </a>
  </div>
...
<div class="pixel-school">

  <!-- FISH 1 -->
  <div class="pixel-fish">
    <!-- Generated pixel layout for fish silhouette -->
    <!-- 80–100 pixel elements recommended -->
    <!-- Example pixels -->
    <div class="pixel" style="top:60px; left:30px;"></div>
    <div class="pixel" style="top:55px; left:40px;"></div>
    <div class="pixel" style="top:50px; left:50px;"></div>
    <div class="pixel" style="top:65px; left:55px;"></div>
    <div class="pixel" style="top:70px; left:70px;"></div>
    <div class="pixel" style="top:60px; left:85px;"></div>
    <div class="pixel" style="top:55px; left:100px;"></div>
    <div class="pixel" style="top:60px; left:115px;"></div>
    <div class="pixel" style="top:65px; left:130px;"></div>
    <div class="pixel" style="top:50px; left:140px;"></div>
  </div>

  <!-- FISH 2 -->
  <div class="pixel-fish">
    <div class="pixel" style="top:62px; left:25px;"></div>
    <div class="pixel" style="top:58px; left:38px;"></div>
    <div class="pixel" style="top:54px; left:52px;"></div>
    <div class="pixel" style="top:68px; left:57px;"></div>
    <div class="pixel" style="top:74px; left:72px;"></div>
    <div class="pixel" style="top:63px; left:88px;"></div>
    <div class="pixel" style="top:58px; left:102px;"></div>
    <div class="pixel" style="top:63px; left:118px;"></div>
    <div class="pixel" style="top:70px; left:132px;"></div>
    <div class="pixel" style="top:54px; left:145px;"></div>
  </div>

  <!-- FISH 3 -->
  <div class="pixel-fish">
    <div class="pixel" style="top:63px; left:30px;"></div>
    <div class="pixel" style="top:59px; left:43px;"></div>
    <div class="pixel" style="top:55px; left:55px;"></div>
    <div class="pixel" style="top:69px; left:60px;"></div>
    <div class="pixel" style="top:73px; left:75px;"></div>
    <div class="pixel" style="top:62px; left:89px;"></div>
    <div class="pixel" style="top:59px; left:105px;"></div>
    <div class="pixel" style="top:64px; left:119px;"></div>
    <div class="pixel" style="top:68px; left:135px;"></div>
    <div class="pixel" style="top:55px; left:148px;"></div>
  </div>
